...
describe('Affix.vue', () => {
  ...
  it('should render offset props', async () => {
    ...
    expect(wrapper.find('.el-affix--fixed').exists()).toBe(true)
    expect(
      wrapper.find('.el-affix--fixed').attributes('style')
    ).toMatchInlineSnapshot(
      '"height: 40px; width: 1000px; top: 30px; z-index: 100;"'
    )
    mockAffixRect.mockRestore()
    mockDocumentRect.mockRestore()
  })
  ...
  it('should render position props', async () => {
    ...
    expect(
      ...
      '"height: 40px; width: 1000px; bottom: 20px; z-index: 100;"'
    )
    mockAffixRect.mockRestore()
    mockDocumentRect.mockRestore()
  })
  ...
  it('should render z-index props', async () => {
    ...
    expect(
      ...
      '"height: 40px; width: 1000px; top: 0px; z-index: 1000;"'
    )
    mockAffixRect.mockRestore()
    mockDocumentRect.mockRestore()
  })
